...
try {
    $prod_id='41551F9C679173BC114D28';
    ...
    if ($data) {
        ...
        $pageTitle = 'the lift collection';
        $metaKeywords = 'the lift collection';
        $metaDescription = 'the lift collection';
    }
} catch (Exception $e) {
...
$canonicalURL = $link."the-lift-collection";
...
$prod_id = '41551F9C679173BC114D28'; // your current product id
...
$prod_id = '41551F9C679173BC114D28'; // example product id
...
$prod_id = '41551F9C679173BC114D28'; // example product_id
...
// The specific product ID for "The Lift"
...
<section>
    <div class="container">
        <div class="escape_room_home_Customer_Reviews_summary">
            ...
            // Product / category ID
            $prod_id = '41551F9C679173BC114D28'; // Replace dynamically if needed
...
<section>
    <div class="escape_room_home_contact_section">
        <div class="container">
            ...
            <a href="#Book_one_single_pr" class="bg_bnt_custom  continue_nex_step"> Book THE LIFT Now</a>
        </div>
    </div>
</section>
