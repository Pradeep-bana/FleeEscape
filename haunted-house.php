...
.vr_page_banner_content img {
    max-width: 350px;
    width: 100%;
}

.vr_page_banner_content p {
    font-size: 25px;

}
</style>
<section>
    <div class="vr_page_banner" style="background-image: url(img/vr/banner_haunted-house.webp);">
        <div class="container">
            <div class="vr_page_banner_content">
                <img src="img/vr/logo_haunted-house.webp" alt="">
                <p>Embody a Warhammer 40,000 Space Marine and unleash your fury</p>
                <a class=" bg_bnt_custom mt-3"
                    href="https://booking.zerolatencyvr.com/en/book-now/seattle?game=spacemarineavarax&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fseattle%2Fexperience%2Fspace-marine-vr&zl_ct=PageBanner&zl_cin=Space%20Marine%20page%20banner&zl_cti=SPACE%20MARINE%20VR%20"
                    target="new">
                    BOOK NOW
                </a>
            </div>
...
.vr_game_deatils_page_layer_item {
...
.vr_game_deatils_page_layer_item:hover {
...
.vr_game_deatils_page_layer_item::before {
    content: "";
    position: absolute;
    top: -50%;
    left: -50%;
...
.vr_game_deatils_page_layer_item:hover::before {
    opacity: 1;
}

.vr_game_deatils_page_layer_item h3 {
    font-size: 20px;
    font-weight: bold;
    color: #00d4ff;
...
.vr_game_deatils_page_layer_item p {
    font-size: 18px;
    color: #fff;
    font-weight: 500;
}
...
<section>
    <div class="container">
        <div class="vr_game_video_modal">
            <img src="img/vr/video_img.webp" alt="">
...
.vr_game_video_modal:hover img {
    transform: scale(1.05);
    filter: brightness(0.7);
}

/* Play Button Wrapper */
.vr_game_video_modal_content {
    position: absolute;
...
.vr_game_video_modal_content i {
    ...
    /* ✅ yaha transform ki jagah transition */
}

.vr_game_video_modal_content i:hover {
    box-shadow: 0 0 50px rgba(0, 212, 255, 0.9) !important;
    transform: rotate(240deg) scale(1.1);
    /* ✅ deg likhna zaroori hai */
}
</style>
    ...
    <div class="all_box_full_width SPACE_MARINE_VR_section">
        <div class="container">
            <div class="SPACE_MARINE_VR">
                <h6>EXCLUSIVE TO ZERO LATENCY VR VENUES WORLDWIDE</h6>
                <h3>SPACE MARINE VR</h3>
                <p>From the Warhammer 40,000 universe, the hotly anticipated Space Marine VR: Defenders of Avarax is
                    coming
                    to Zero Latency <br> VR venues globally. Available Now.</p>
            </div>
            <div class="row align-items-center">
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>A FIERCE THREAT</h1>
                        <p>You are a Space Marine. A genetically enhanced super-soldier. A highly disciplined and
                            indomitable warrior. In the expansive Hive City of Fervastium, you will delve deep into a
                            vault on a vital mission. If successful, you could turn the tide and help beat back the
                            Tyranids, an all-consuming alien swarm from beyond the known galaxy.
                        </p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_img ">
                        <img src="img/vr//vr1.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="img/vr/vr2.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>UNLEASH YOUR INNER WARRIOR</h1>
                        <p>In the grim darkness of the far future, the enemy is relentless. There is no time for peace.
                            No respite. No forgiveness. There is only war. Using a wide range of weapons from the
                            Warhammer 40,000 universe, you’ll fight off voracious swarms of Tyranids. Prepare yourself
                            for battle and fight in epic skirmishes against overwhelming odds.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>OUR BIGGEST WORLD YET</h1>
                        <p>In mind-bending, immersive VR, reality has been ripped apart. Brace yourself for an
                            adrenaline rush surging through your veins and step into extraordinary spaces as you explore
                            the thrilling world of Warhammer 40,000 like you’ve never seen before. In a future plagued
                            by war, gather your friends to create unforgettable moments in an intense adventure like no
                            other.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="img/vr/vr3.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
...
<section class="leaderboard_section">
    <div class="container">
        <div class="SPACE_MARINE_VR">
            <h5>Seattle</h5>
            <h3>SPACE MARINE VR Leaderboard</h3>
    ...
    <div class="container ">
        ...
        <div class="owl-carousel owl-theme vr_game_slider">
            <div class="item">
                    ...
                    <div class="room-content">
                        <div class="room-content_all_ah">
                            <div class="room-details">
                                <h3 class="room-title" style=" background: linear-gradient(90deg, #d4a0ff, #ffffff, #d4a0ff);
                ...
                <h6 class="color_combination_vr_function text-center">AWAKEN YOUR <span class="green-highlight"
                        style="color: #cbfd3c;">SQUAD TACTICS</span></h6>
            </div>
            <div class="item">
                <div class="room-card">
                    <div class="room-image haunted-hotel"
            ...
            <div class="item">
                ...
                <h6 class="color_combination_vr_function text-center">AWAKEN THE <span class="green-highlight"
                        style="color: #c5a4f4;">HERO </span>IN YOU</h6>
            </div>
            <div class="item">
                <div class="room-card">
                    <div class="room-image haunted-hotel"
                ...
                <h6 class="color_combination_vr_function text-center">AWAKEN YOUR <span class="green-highlight"
                        style="color: #ed6000;">INNER SURVIVOR</span></h6>
            </div>
            <div class="item">
                <div class="room-card">
                    <div class="room-image haunted-hotel"
                ...
                <h6 class="color_combination_vr_function text-center">AWAKEN YOUR <span class="green-highlight"
                        style="color: #c5a4f4;">FIERCE COMPETITOR</span></h6>
            </div>
            <div class="item">
                <div class="room-card">
                    <div class="room-image haunted-hotel"
                ...
                <h6 class="color_combination_vr_function text-center">AWAKEN THE <span class="green-highlight"
                        style="color: #c5a4f4;">LEADER</span> IN YOU</h6>
            </div>
            <div class="item">
                <div class="room-card">
                    <div class="room-image haunted-hotel"
                ...
                <h6 class="color_combination_vr_function text-center">AWAKEN YOUR <span class="green-highlight"
                        style="color: #cbfd3c;">IMAGINATION</span></h6>
            </div>
            <div class="item">
                <div class="room-card">
                    <div class="room-image haunted-hotel"
                ...
                <h6 class="color_combination_vr_function text-center">AWAKEN THE <span class="green-highlight"
                        style="color: #00d4ff;">TACTICIAN</span> IN YOU</h6>
            </div>
        </div>
    </div>
</section>
...
.Release_your_inner h3 {
    color: #000;
    text-transform: uppercase;
    font-size: 28px;
}

.Release_your_inner p {
    color: #000;
    font-size: 16px;
}

.Release_your_inner button {
...
.Release_your_inner button:hover {
    background-color: #00d4ff;
    color: #fff;
