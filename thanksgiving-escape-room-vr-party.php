...
$canonicalURL = $link."thanksgiving-escape-room-vr-party";
$videoModalTitle = 'Thanks Giving';
...
$stmt->execute([':page' => 'thanksgiving']);
$pageData = $stmt->fetch(PDO::FETCH_ASSOC);
...
$selectedPage = 'thanksgiving'; // can be dynamic as needed
...
// Fetch data for selected page
$selectedPage = 'thanksgiving'; // change dynamically if needed
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="videoModalLabel"><?=$videoModalTitle?></h5>
...
// Fetch data for selected page
$selectedPage = 'thanksgiving'; // set dynamically if needed
...
$selectedPage = 'thanksgiving'; // or dynamic based on current page
...
// Define selected page
$selectedPage = 'thanksgiving'; // Replace dynamically if needed
