...
// Collect product IDs for the relevant products
$productIds = [];
$count = 0;
foreach ($data['data'] as $product) {
   // This logic to only show products 13 and 14 is preserved
...
document.addEventListener("click", function(e) {
    ...
    .then(response => {
        ...
        if (response.status !== "success") {
            ...
            showBookeoError(response.message || "This time slot is no longer available.");
            return;
        }
