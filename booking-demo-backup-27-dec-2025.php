                        ...
                        <div id="carouselExampleFade" class="carousel slide carousel-fade custom-carousel"
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./assets/images/fleeescape_img/banner/baneer2.jpg" loading="lazy"  decoding="async"  class="d-block w-100"
                                        alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="./assets/images/fleeescape_img/banner/banne1.jpg" loading="lazy"  decoding="async"  class="d-block w-100"
                                        alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="./assets/images/fleeescape_img/banner/Booking_baneer_img.png" loading="lazy"  decoding="async" 
