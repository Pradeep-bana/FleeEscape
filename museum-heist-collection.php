...
try {
    $prod_id='41551Y4PM9614F91DD1BC6';
    ...
    if ($data) {
        ...
        $pageTitle = 'Museum Heist';
        $metaKeywords = 'Museum Heist';
        $metaDescription = 'Museum Heist';
    }
} catch (Exception $e) {
...
$canonicalURL = $link."museum-heist-collection";
...
$prod_id = '41551Y4PM9614F91DD1BC6'; // your current product id
...
$prod_id = '41551Y4PM9614F91DD1BC6'; // example product id
...
$prod_id = '41551Y4PM9614F91DD1BC6'; // example product_id
...
// The specific product ID for this page ("Museum Heist")
$productId = '41551Y4PM9614F91DD1BC6';
$data = null;
...
<section>
    <div class="container">
        <div class="escape_room_home_Customer_Reviews_summary">
            ...
            // Product / category ID
            $prod_id = '41551Y4PM9614F91DD1BC6'; // Replace dynamically if needed
...
<section>
    <div class="escape_room_home_contact_section">
        <div class="container">
            ...
            <a href="#Book_one_single_pr" class="bg_bnt_custom  continue_nex_step"> Book MUSEUM HEIST Now</a>
        </div>
    </div>
</section>
