...
try {
    $prod_id='41551HE99XR14F91DF96B0';
    ...
    if ($data) {
        ...
        $pageTitle = 'prison-escape';
        $metaKeywords = 'prison-escape';
        $metaDescription = 'prison-escape';
    }
} catch (Exception $e) {
...
$canonicalURL = $link."prison-escape-collection";
...
$prod_id = '41551HE99XR14F91DF96B0'; // your current product id
...
$prod_id = '41551HE99XR14F91DF96B0'; // example product id
...
$prod_id = '41551HE99XR14F91DF96B0'; // example product_id
            ...
            <div class="col-md-3 col-6">
                <div class="gallery-item position-relative">
                    <a href="<?php echo $imgPath; ?>" data-fancybox="vr">
                        <img src="<?php echo $imgPath; ?>" class="img-fluid rounded shadow-sm" loading="lazy" alt="Escape Room">
                ...
                <div class="Boo_Prison_Escape_time_box" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="600">
                    <div class="Boo_Prison_Escape_booking_summary_box">
                        ...
                        <div class="next-button-wrapper">
                              ...
                              <?php echo '<button 
                            class="continueBtn bg_bnt_custom  continue_nex_step1 disabled" 
                                ...
                                <div class="d-flex mb-2 align-items-center">
                                    <?php if ($image) { ?>
                                        <img src="<?php echo $image; ?>" 
                                             loading="lazy"
                                             class="escape_room_home_Customer_Reviews_avatar_img rounded-circle"
                                             alt="<?php echo $name; ?>"
                                             width="40" height="40">
                                    <?php } else { ?>
                                        <div class="escape_room_home_Customer_Reviews_avatar">
                                            <?php echo $avatar; ?>
                                        </div>
                                    <?php } ?>
...
<section>
    <div class="container">
        <div class="escape_room_home_Customer_Reviews_summary">
            ...
            // Product / category ID
            $prod_id = '41551HE99XR14F91DF96B0'; // Replace dynamically if needed
    ...
    <div class="escape_room_home_contact_section">
        <div class="container">
           ...
           <div class="row">
            ...
            <a href="#Book_one_single_pr" class="bg_bnt_custom  continue_nex_step"> Book Prison Escape Now</a>
        </div>
    </div>
</section>
...
<style>
/* ── Hide Flatpickr's native year number input + arrows ──────────────
   Calendar renders INSIDE #Book-Prison-Date (child, not sibling),
   so use a descendant selector, NOT the ~ sibling combinator.        */
#Book-Prison-Date ~ .flatpickr-calendar .numInputWrapper {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.status === "success") {
                    // Must create holds BEFORE redirecting
...
<script>
var modal = document.getElementById('Indoormodal');
