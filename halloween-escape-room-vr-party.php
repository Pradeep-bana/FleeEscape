...
$canonicalURL = $link."halloween-escape-room-vr-party";

$videoModalTitle = 'Halloween';
...
$selectedPage = 'halloween'; // can be dynamic as needed
...
// Fetch data for selected page
$selectedPage = 'halloween'; // change dynamically if needed
...
// Fetch data for selected page
$selectedPage = 'halloween'; // set dynamically if needed
...
$selectedPage = 'halloween'; // or dynamic based on current page
...
// Define selected page
$selectedPage = 'halloween'; // Replace dynamically if needed
