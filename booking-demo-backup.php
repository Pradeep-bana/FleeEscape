...
<div class="booking_banner">
    <img src="./assets/images/fleeescape_img/banner//Booking_baneer_img.png" alt="booking baneer" />
...
<div class="container">
    ...
    <div class="timer_wrapper" style="display: none;">
        <h3 class="timer_header">You have <span class="timer_display">10:00</span>
                        ...
                        <div class="payment_btnrow_tab">
                            ...
                            <!--<button><strong>G</strong> Pay</button>-->
                             <button class="payment_voucher_tab" 
                                    onclick="window.open('booking-demo#gift-card', '_blank');">
                                GIFT VOUCHER
                            </button>
                        ...
                        <div class="payment_images_done">
                            <div class="booking_done_img_main">
                                <div class="booking_done_img_main_img">
                                    <img src="./assets/images/fleeescape_img/CHOOSE/4.jpg" alt="Payment BG img" />
                                </div>
                                <div class="booking_done_img_main_gallery">
                                    <img src="./assets/images/fleeescape_img/party_pack/Corporate.jpg" alt="">
                                    <img src="./assets/images/fleeescape_img/party_pack/Kids.png" alt="">
                                    <img src="./assets/images/fleeescape_img/party_pack/Portable.jpg" alt="">
                                </div>
                            </div>
            ...
            <div class="booking-summary-box" data-aos="fade-left">
                    ...
                    <div class="voucher_code_new_design vr-waiver-dark">
                        ...
                        <div class="voucher_code__flex">
                            <div class="voucher_code__flex_code">
                                ...
                                <p class="applied_code"> <span class="code">Have a promotion or voucher code?</span></p>
                                <div class="applied_code_remove">
                                    <button><i class="fa-solid fa-delete-left"></i></button>
                                </div>
                            </div>
               ...
               <div id="booking-response" ></div>     
                    ...
                    <div class="all_button_main_header order_summart_main_button mt-4">
                        <a href="javascript:void(0)" onclick="changeStep(-1)" class="bg_bnt_custom">Back</a>
                        <!-- all tab buttons here -->
                        <a onclick="changeStep(1)" class="bg_bnt_custom step-1-bnt_continue">Continue </a>
                        <a onclick="" class="bg_bnt_custom step-2-bnt_continue">Continue </a>
                        <a  class="bg_bnt_custom step-3-bnt_continue">Place Your Order</a>
...
<!-- === info modal ====== -->
<div class="modal fade" id="liftInfoModal" tabindex="-1" aria-labelledby="liftInfoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content custom-modal">
            <div class="modal-header border-0" style="align-items: flex-start!important;">
                <div class="info_modal_content" style="width: 90%;">
                    <h2 class="modal-title custom-heading" id="liftInfoModalLabel">
                        The Lift: A 1920s Private Game Experience
                    </h2>
                    <p>🔥 Hurry this game has been booked 40 times in the last 30 days,</p>
                </div>
                <button type="button" class="btn btn-sm close-btn" data-bs-dismiss="modal" aria-label="Close">✕</button>
            </div>
            <div class="modal-body">
                        ...
                        <div id="carouselExampleFade" class="carousel slide carousel-fade custom-carousel"
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="./assets/images/fleeescape_img/banner/baneer2.jpg" class="d-block w-100"
                                        alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="./assets/images/fleeescape_img/banner/banne1.jpg" class="d-block w-100"
                                        alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="./assets/images/fleeescape_img/banner/Booking_baneer_img.png"
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="game-stats d-flex flex-wrap gap-3 mb-3">
                            ...
                            <div class="stat-box">
                                ...
                                <span class="stat-value">Novice</span>
                            </div>
                            <div class="stat-box">
                            ...
                            <div class="stat-box">
                                ...
                                <span class="stat-value">$40 / Player</span>
                            </div>
                            <div class="stat-box">
                                <span class="stat-label">
                                    <i class="fas fa-vector-square me-1"></i> Layout
                                </span>
                                <span class="stat-value">Single Room</span>
                            </div>
                        </div>
                        <div class="modal_info_p">
                            <p>
                                It’s the roaring 20s and you’ve been invited to an exclusive party at the fanciest hotel
                                around...
                                But something’s not right. This is no ordinary party.
                            </p>
                            <p>
                                The Lift is our only single-room experience, but don’t be fooled—
                                it’s still packed with puzzles and surprises to keep your group guessing!
                            </p>
                        </div>
                ...
                <div class=" all_button_main_header text-end"
                    style="background-size: cover; background-repeat: no-repeat; ">
                    <a style="border-radius: 30px!important " class=" bg_bnt_custom bg_bnt_custom_tran "
                        data-bs-toggle="modal" data-bs-target="#videoModal"><i class="fa-solid fa-play m-2"></i>
                        Watch Trailer</a>
...
<div id="deleteConfirmModal" class="custom-modal-overlay">
    <div class="custom-modal p-4 text-center" id="deleteModalBox">
        ...
        <div id="deleteLoading">
            ...
            <p class="loading-text">Deletingâ€¦ Please wait</p>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (mobileDropdown) {
        mobileDropdown.addEventListener('change', function() {
            // Remove hash from URL when mobile dropdown is changed
            const newUrl = window.location.pathname + window.location.search;
            window.history.replaceState(null, null, "#" + hash);
        });
    }
...
function processStepContinue(
    ...
    // CHOOSE ENDPOINT
    let targetUrl =
        sessionPromoCodeCart || giftCode ||
        (sessionPromoCode && sessionPromotionPage === "true") ||
        (sessionAddonname && sessionAddonqty)
            ? "save_session.php"
            : "save_without_giftcart.php";

    $.ajax({
        url: targetUrl,
        type: "POST",
        data: {
            firstName, lastName, email, phone, type, giftCode
        },
        ...
        success: function (response) {
            ...
            try {
                ...
                $("#booking-response").html(`<div class="error-box">Error processing response.</div>`);
                return;
            }
            ...
            if (res.status === "error") {
                ...
                $("#booking-response").html(`<div class="error-box">${msg}</div>`);
                return;
            }
            ...
            if (res.bookings && res.bookings.length > 0) {
                ...
                res.bookings.forEach(b => {
                    if (b.status !== "booked") {
                        let msg = b.messages && b.messages.length ? b.messages.join(", ") : "Booking failed.";
                        bookingErrors.push(`• ${msg}`);
                    }
                });
                if (bookingErrors.length > 0) {
                    $("#booking-response").html(`<div class="error-box">${bookingErrors.join("<br>")}</div>`);
                    return;
                }
            }
        ...
        error: function (xhr) {
            $("#booking-response").html(`<div class="error-box">Server error: ${xhr.responseText}</div>`);
        },
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    productIds.forEach(productId => {
                        ...
                        const allowNextDayByTime = laNow.hour >= 21;
                        if (html.includes("No slots available") && allowAutoNextDay && allowNextDayByTime) {
                            const $input = $(`.custom-datepicker_input[data-product="${productId}"]`);
                            if ($input.length) {
    ...
    function initDatePickers(container = $(document)) {
        container.find('.custom-datepicker_input').each(function(index) {
            ...
            if ($input.hasClass('flatpickr-mobile')) {
                console.log(`initDatePickers: Skipping flatpickr-mobile at index=${index}`);
                return;
            }
            ...
            flatpickr($input[0], {
                ...
                onReady: () => {
                    // Remove flatpickr’s duplicate input if it still gets added
                    const duplicates = document.querySelectorAll('.flatpickr-mobile');
                    duplicates.forEach(inp => inp.remove());

                    // Make sure main input is visible and text type
                ...
                onChange: (selectedDates) => {
                    if (!selectedDates || !selectedDates[0]) {
                        console.log(`initDatePickers: No date selected for product=${productId}`);
                        return;
                    }
                    ...
                    console.log(`initDatePickers: Datepicker changed: product=${productId}, setting date to ${picked.toISODate()}`);
                    setDateAll(picked);
                }
            });
        });
        ...
        console.log(`initDatePickers: Initial fetch for productIds: ${JSON.stringify(productIds)}`);
...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    try {
        ...
        const paymentResult = await createPayment(token, hasGiftCode);

        if (paymentResult.errors) {
            showError(paymentResult.errors[0]?.detail || "Payment failed.");
            return;
        }

        if (paymentResult.error) {
            showError(paymentResult.error.detail || "Payment failed.");
            return;
        }

        // SUCCESS
        statusContainer.innerHTML = `
            <div style="color:green; padding:10px; font-weight:600;">
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 800px;">
        <div class="modal-content custom-modal text-white" style="background-color: #0e0e0e; border-radius: 20px;">
            <div class="modal-header border-0 pb-0">
                ...
                <button onclick="changeStep(1)" type="button" class="btn-close position-absolute end-0 me-3 mt-3"
            ...
            <div class="modal-body px-3 pt-0 pb-3 d-flex flex-column justify-content-between">
                ...
                <div class="all_button_main_header">
                    <a href="#to_book_scroll" onclick="changeStep(1)" data-bs-dismiss="modal"
                        class="bg_bnt_custom bg_bnt_custom_tran">Skip</a>
        ...
        <div class="modal-content custom-modal voucher-modal-content">
            ...
            <div class="modal-body voucher-modal-body ">
                <form class="voucher-form" >
                    ...
                    <input type="text" id="giftCodeInput" class="voucher-form-input" placeholder="Enter your code">
                </form>
                <div>
...
(function() {
    ...
    function loadCart() {
        ...
        fetch("cart_view.php?live=1")
            .then(res => res.text())
            .then(html => {
                // Redirect if backend says cart is empty
                if (html.includes("data-totals") === false) {
                    window.location.href =
                        "booking-demo.php?choose-experience";
                    return;
                }
                ...
                if (data.status === "success") {
                    ...
                    if (modal) {
                        ...
                        modalEl.addEventListener('hidden.bs.modal', () => {
                            ...
                            // ✅ Move to next step
                            if (typeof changeStep === "function") changeStep(1);
                        }, { once: true });
                    } else {
...
$(document).on("change", ".qty-input", function () {
    let gameId = $(this).attr("id").replace("guest-", "");
    let newQty = $(this).val();
...
const tabItems = document.querySelectorAll('.custom-tab-nav .tab-item');

dropdown.addEventListener('change', function() {
    const targetId = this.value;

    // Find the corresponding tab-item and trigger click
    const tabToClick = document.querySelector(`.custom-tab-nav .tab-item[data-bs-target="${targetId}"]`);
    if (tabToClick) {
        tabToClick.click(); // this triggers Bootstrap pill/tab behavior
    }
});
</script>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const targetEl = document.getElementById("stepContents");

    if (!targetEl) return;

    autoScrollButtons.forEach(button => {
        button.addEventListener("click", (e) => {
            e.preventDefault(); // agar <a> tag hai to page reload/redirect rokne ke liye

            const yOffset = -120; // fixed header ho to adjust kar sakte ho
            const y =
