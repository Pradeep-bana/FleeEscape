<?php
$pageTitle = 'Engineerium';
include('../includes/header.php');
?>

<section>
    <div class="vr_page_banner" style="background-image: url(../img/vr/Engineerium/banner.webp);">
        <div class="container">
            <div class="vr_page_banner_content">
                <img src="../img/vr/Engineerium/logo.webp" alt="">
                <p>A dreamy world where sideways thinking is encouraged</p>
                <a class=" bg_bnt_custom mt-3"
                    href="https://booking.zerolatencyvr.com/en/?game=engineerium&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fexperience%2Fengineerium&zl_ct=PageBanner&zl_cin=HQ%20%7C%20Page%20Banner%20%7C%20Engineerium&zl_cti=ENGINEERIUM"
                    target="new">
                    BOOK NOW
                </a>
            </div>
...
<section>
    <div class="container">
        <div class="vr_game_video_modal">
            <img src="../img/vr/Engineerium/video_bannner.webp" alt="">
    ...
    <div class="all_box_full_width SPACE_MARINE_VR_section">
        <div class="container">
            <div class="SPACE_MARINE_VR">
                <h6>EMBRACE YOUR CURIOSITY</h6>
                <h3>AWAKEN YOUR INNER STRATEGIST</h3>
                <p>Down to forget which way is up? You’ve come to the right dazzling dimension. Puzzle your way through
                    a fantastical path in the clouds, where a host of delightful views and visions await your discovery.
                    Don’t get swept away, as you get swept up in the wonders while you and your team have a tribe to
                    reunite. </p>
                    <a class=" bg_bnt_custom mt-2 mb-5"  href="https://booking.zerolatencyvr.com/en/?game=engineerium&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fexperience%2Fengineerium&zl_ct=PageBanner&zl_cin=HQ%20%7C%20Page%20Banner%20%7C%20Engineerium&zl_cti=ENGINEERIUM"
                    target="new">
                    BOOK NOW</a>
            </div>
            <div class="row align-items-center">
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>Work together</h1>
                        <p>Working as one is key to finding solid ground. Walk up ramps that lead you through confusing
                            pathways and over floating platforms. Don’t look down, unless you want to admire the
                            beautiful glistening water, very, very, far below.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_img ">
                        <img src="../img/vr/Engineerium/vr1.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/Engineerium/vr2.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>Take it all in</h1>
                        <p>Take a moment to wonder at the world and awaken your imagination as you float among a
                            fantastical, technicolor landscape in the clouds. Make sure to wave at the mystical sea
                            creatures as they swim past you in the sky, they’re friendly!</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>A satisfying reunion</h1>
                        <p>The tribe is eternally grateful for your effort. Join in the joy with dancing, music and
                            lights — you’ve earned this celebration.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/Engineerium/vr3.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
