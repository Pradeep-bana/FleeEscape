...
<section>
    <div class="vr_page_banner" style="background-image: url(../img/vr/outbreak/banner.webp);">
        <div class="container">
            <div class="vr_page_banner_content">
                <img src="../img/vr/outbreak/OutbreakLogo.webp" alt="">
                <p>Can you find the cure and save humankind?</p>
                <a class=" bg_bnt_custom mt-3"
                    href="https://booking.zerolatencyvr.com/en/?game=outbreak&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fexperience%2Foutbreak&zl_ct=PageBanner&zl_cin=HQ%20%7C%20Page%20Banner%20%7C%20OutBreak&zl_cti=OUTBREAK"
                    target="new">
                    BOOK NOW
                </a>
            </div>
...
<section>
    <div class="container">
        <div class="vr_game_video_modal">
            <img src="../img/vr/outbreak/video_banner.webp" alt="">
    ...
    <div class="all_box_full_width SPACE_MARINE_VR_section">
        <div class="container">
            <div class="SPACE_MARINE_VR">
                <h6>FACE HORDES OF FLESH-HUNGRY ZOMBIES TO</h6>
                <h3>AWAKEN YOUR INNER HERO</h3>
                <p>Amidst the chaos of a global zombie apocalypse – you find yourself guardian of the only cure.

                    When the lab you’re protecting has been infiltrated, you’ll have to fend off flesh-hungry hordes of
                    the undead, calm your beating heart as you creep through abandoned hospitals, shoot your way out of
                    swampy basements and cross death defying heights. All in an adrenaline-pumping bid to save humanity.
                </p>
                <a class=" bg_bnt_custom mt-2 mb-5"  href="https://booking.zerolatencyvr.com/en/?game=outbreak&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fexperience%2Foutbreak&zl_ct=PageBanner&zl_cin=HQ%20%7C%20Page%20Banner%20%7C%20OutBreak&zl_cti=OUTBREAK"
                    target="new">
                    BOOK NOW</a>
            </div>
            <div class="row align-items-center">
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>ESCAPE THE SEWERS</h1>
                        <p>The only thing worse than finding yourself in the grimy depths of a city's sewer system, is
                            surviving it with an endless torrent of vicious zombies. Protect your friends, or fend for
                            yourself — just get out of there ASAP!</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_img ">
                        <img src="../img/vr/outbreak/vr1.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/outbreak/vr2.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>Take flight</h1>
                        <p>Awaken your inner hero and feel breathlessly alive, as you jump into a helicopter, and find
                            yourself flying high over a ravaged city full of burning buildings and the sounds of
                            gunfire.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>A glorious final battle</h1>
                        <p>It’s not just the undead you have to worry about. Keep your wits about you and an eye out for
                            armed mercenaries, and even battle a helicopter. It all comes down to how you handle this
                            moment.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/outbreak/vr3.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="Release_your_inner_section">
        ...
        <div class="Release_your_inner">
            <div class="container">
                ...
                <p>Find your closest Zero Latency VR</p>
