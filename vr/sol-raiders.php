<?php
$pageTitle = 'Sol Raiders';
include('../includes/header.php');
?>

<section>
    <div class="vr_page_banner" style="background-image: url(../img/vr/Sol-Raiders/banner.webp);">
        <div class="container">
            <div class="vr_page_banner_content">
                <img src="../img/vr/Sol-Raiders/SR_Logo_3D.webp" alt="">
                <p>Feeling competitive? Time to pit your teammates against each other!</p>
                <a class=" bg_bnt_custom mt-3"
                    href="https://booking.zerolatencyvr.com/en/?game=solraiders&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fexperience%2Fsol-raiders&zl_ct=PageBanner&zl_cin=HQ%20%7C%20Page%20Banner%20%7C%20Sol%20Raiders&zl_cti=SOL%20RAIDERS"
                    target="new">
                    BOOK NOW
                </a>
            </div>
...
<section>
    <div class="container">
        <div class="vr_game_video_modal">
            <img src="../img/vr/Sol-Raiders/video_banner.webp" alt="">
    ...
    <div class="all_box_full_width SPACE_MARINE_VR_section">
        <div class="container">
            <div class="SPACE_MARINE_VR">
                <h6>BRING GLORY TO YOUR TEAM</h6>
                <h3>AWAKEN YOUR INNER STRATEGIST</h3>
                <p>Split into two teams and battle it out for the win across three adrenaline-fueled environments.
                    Capture the objectives, stay alive, and earn that glorious victory.</p>
                    <a class=" bg_bnt_custom mt-2 mb-5" href="https://booking.zerolatencyvr.com/en/?game=solraiders&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fexperience%2Fsol-raiders&zl_ct=PageBanner&zl_cin=HQ%20%7C%20Page%20Banner%20%7C%20Sol%20Raiders&zl_cti=SOL%20RAIDERS"
                    target="new">
                    BOOK NOW</a>
            </div>
            <div class="row align-items-center">
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>Three unique maps</h1>
                        <p>Overcome your nerves in the Turbine Station, discover your deceptive side in the Dark Wreck
                            and put it all on the line in the sunny Mining Canyon. While each new area has a unique
                            objective, the mission is always the same - score points for your team and chase the rush of
                            a win.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_img ">
                        <img src="../img/vr/Sol-Raiders/vr1.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/Sol-Raiders/vr2.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>Three unique objectives</h1>
                        <p>Each game is unique to its location, but the mission is simple. Defend your crew, capture the
                            objective, or play decoy to distract the other team – all in an exhilarating mission to
                            score points and win at all costs. It’s that simple.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>Avenge losses, prove wins</h1>
                        <p>It’s normal to get addicted to the glory, why deny yourself the rush? Play again and again,
                            trying different strategies and switching teammates. There’s no better thrill than reigning
                            supreme on the leaderboard.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/Sol-Raiders/vr3.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
...
<section class="leaderboard_section" style="display: none;">
    <div class="container">
        <div class="SPACE_MARINE_VR">
            <h5>Seattle</h5>
            <h3>UNDEAD ARENA Leaderboard</h3>
...
<section>
    <div class="Release_your_inner_section">
        ...
        <div class="Release_your_inner">
            <div class="container">
                <h3>Release your inner thrill seeker</h3>
                <p>Find your closest Zero Latency</p>
