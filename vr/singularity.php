...
<section>
    <div class="vr_page_banner" style="background-image: url(../img/vr/Singularity/bannner.webp);">
        <div class="container">
            <div class="vr_page_banner_content">
                <img src="../img/vr/Singularity/singularity-logo.webp" alt="">
                <p>Fight off killer robots with your team</p>
                <a class=" bg_bnt_custom mt-3"
                    href="https://booking.zerolatencyvr.com/en/?game=singularity&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fexperience%2Fsingularity&zl_ct=PageBanner&zl_cin=HQ%20%7C%20Page%20Banner%20%7C%20Singularity&zl_cti=SINGULARITY"
                    target="new">
                    BOOK NOW
                </a>
            </div>
...
<section>
    <div class="container">
        <div class="vr_game_video_modal">
            <img src="../img/vr/Singularity/video_baneer.webp" alt="">
    ...
    <div class="all_box_full_width SPACE_MARINE_VR_section">
        <div class="container">
            <div class="SPACE_MARINE_VR">
                <h6>MAN V MACHINE</h6>
                <h3>AWAKEN THE LEADER IN YOU</h3>
                <p>When the secret base is infiltrated, you and your teammates will have to battle armed robots and
                    ruthless attack drones as you fight to take back control.</p>
                    <a class=" bg_bnt_custom mt-2 mb-5" href="https://booking.zerolatencyvr.com/en/?game=singularity&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fexperience%2Fsingularity&zl_ct=PageBanner&zl_cin=HQ%20%7C%20Page%20Banner%20%7C%20Singularity&zl_cti=SINGULARITY"
                    target="new">
                    BOOK NOW</a>
            </div>
            <div class="row align-items-center">
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>Take charge</h1>
                        <p>Once the power’s cut, there’s no time to waste. Endless units of killer robots are coming
                            from all directions. You’ve got seconds to strategise, so brace yourself to make calls, or
                            take orders from your team — for the sake of everyone's survival.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_img ">
                        <img src="../img/vr/Singularity/vr1.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/Singularity/vr2.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>Don’t lose your head</h1>
                        <p>Discover hidden determination as you bravely venture through narrow corridors and take dodgy
                            lifts to reach your target destination. Remember, you’ve got a mission to complete. </p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>Find what’s infiltrated the base</h1>
                        <p>You’ve found the source of the problem, now it’s your job to deal with it. Time to play hero
                            and unleash the leader within — your team is relying on it.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/Singularity/vr3.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
