<?php
$pageTitle = 'Undead Arena';
include('../includes/header.php');
?>

<section>
    <div class="vr_page_banner" style="background-image: url(../img/vr/Undead-Arena/banner.webp);">
        <div class="container">
            <div class="vr_page_banner_content">
                <img src="../img/vr/Undead-Arena/logo.webp" alt="">
                <p>Fight flesh-hungry zombies as a contestant in a chilling game show</p>
                <a class=" bg_bnt_custom mt-3"
                    href="https://booking.zerolatencyvr.com/en/?game=undeadarena&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fexperience%2Fundead-arena&zl_ct=ContentType360Video&zl_cin=Global%20%7C%20Undead%20%7C%20360%20Video%20Page%20Banner%20"
                    target="new">
                    BOOK NOW
                </a>
            </div>
...
<section>
    <div class="container">
        <div class="vr_game_video_modal">
            <img src="../img/vr/Undead-Arena/video_banner.webp" alt="">
    ...
    <div class="all_box_full_width SPACE_MARINE_VR_section">
        <div class="container">
            <div class="SPACE_MARINE_VR">
                ...
                <h3>AWAKEN YOUR INNER SHOWMAN</h3>
                <p>Fighting zombies in neon lights is more fun than meeting them in the dark. Say no to fear, and fight
                    for your right to survive with style. Try to take inspiration from the show's presenter as his voice
                    booms around the arena. You can’t escape, so you may as well give the audience what they’re dying
                    for.</p>
                    <a class=" bg_bnt_custom mt-2 mb-5"  href="https://booking.zerolatencyvr.com/en/?game=undeadarena&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fexperience%2Fundead-arena&zl_ct=ContentType360Video&zl_cin=Global%20%7C%20Undead%20%7C%20360%20Video%20Page%20Banner%20"
                    target="new">
                    BOOK NOW</a>
            </div>
            <div class="row align-items-center">
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>Get creative</h1>
                        <p>Interact with the various neon signs to set off booby traps and satisfying explosions that
                            keep the endless torrent of the undead from surrounding you completely. Don’t feel bad if
                            you start having fun.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_img ">
                        <img src="../img/vr/Undead-Arena/vr1.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/Undead-Arena/vr2.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>Go wild</h1>
                        <p>Moving platforms and bridges mean you don’t have to stay in one place. The entire arena is
                            your stage, so make sure to use it. Feel uninhibited freedom to move around, jump and spin
                            to your heart's content. Will you activate your inner champion or release your savagely
                            strategic side? Time to find out. </p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>Claim your crown</h1>
                        <p>Check your scores at the end and compare them with your teammates. Bragging is highly
                            encouraged.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/Undead-Arena/vr3.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
