<?php
$pageTitle = 'Far Cry VR';
include('../includes/header.php');
?>

<section>
    <div class="vr_page_banner" style="background-image: url(../img/vr/far-cry-vr/banner.webp);">
        <div class="container">
            <div class="vr_page_banner_content">
                <img src="../img/vr/far-cry-vr/logo.webp" alt="">
                <p>Feel uncaged excitement as you make a thrilling escape</p>
                <a class=" bg_bnt_custom mt-3"
                    href="https://booking.zerolatencyvr.com/en/?game=farcryvr&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fexperience%2Ffar-cry-vr&zl_ct=PageBanner&zl_cin=HQ%20%7C%20Page%20Banner%20%7C%20Far%20Cry%20VR&zl_cti=FAR%20CRY%20VR"
                    target="new">
                    BOOK NOW
                </a>
            </div>
...
<section>
    <div class="container">
        <div class="vr_game_video_modal">
            <img src="../img/vr/far-cry-vr/video_banner.webp" alt="">
    ...
    <div class="all_box_full_width SPACE_MARINE_VR_section">
        <div class="container">
            <div class="SPACE_MARINE_VR">
                <h6>UNCAGE PRIMAL INSTINCTS</h6>
                <h3>AWAKEN THE SURVIVOR IN YOU</h3>
                <p>When you decided to explore the jungle, you probably didn’t expect to run into a bored local gang of
                    pirates, eager to hunt you for sport. You need to get out, NOW. Fend them off from open air
                    gondolas, find cover in strange caves, and fight an epic battle deep in the heart of the jungle.</p>
          <a class=" bg_bnt_custom mt-2 mb-5" href="https://booking.zerolatencyvr.com/en/?game=farcryvr&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fexperience%2Ffar-cry-vr&zl_ct=PageBanner&zl_cin=HQ%20%7C%20Page%20Banner%20%7C%20Far%20Cry%20VR&zl_cti=FAR%20CRY%20VR"
                    target="new">
              BOOK NOW</a>
                </div>
            <div class="row align-items-center">
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>WELCOME TO SUNNY ROOK ISLANDS</h1>
                        <p>Despite the bliss of sparkling clear, aqua seas and buttery yellow sand — this is no tropical
                            getaway. Jump on rickety old gondolas to try to survive. Enjoy the view, just don’t forget
                            there are enemies lurking around every corner, crate and palm tree.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_img ">
                        <img src="../img/vr/far-cry-vr/vr1.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/far-cry-vr/vr2.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>Take a shortcut through strange caves</h1>
                        <p>It might be a quicker route to the temple, but it’s definitely more dangerous. Watch out for
                            the luminescent mushrooms lighting your path, they’re known to play tricks on your senses.
                        </p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>Face your enemies</h1>
                        <p>You’re now in the deepest depths of the jungle, and Vaas’s gang has you surrounded. Time to
                            calm your racing pulse, dig deep, get fierce — and fight back.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/far-cry-vr/vr3.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
