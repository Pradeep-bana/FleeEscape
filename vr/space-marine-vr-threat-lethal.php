...
<section>
    <div class="vr_page_banner" style="background-image: url(../img/vr/threat-lethal/banner.webp);">
        <div class="container">
            <div class="vr_page_banner_content">
                <img src="../img/vr/threat-lethal/logo_Threat-Lethal.webp" alt="">
                <p>How far will you make it in our thrilling new team challenge?</p>
                <a class=" bg_bnt_custom mt-3"
                    href="https://booking.zerolatencyvr.com/en/?game=SpaceMarineThreatLethal30&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fexperience%2Fspace-marine-vr-threat-lethal&zl_ct=PageBanner&zl_cin=%5BHQ%5D%20Global%20%7C%20Threat%20Lethal%20Page%20Banner&zl_cti=SPACE%20MARINE%20VR%20THREAT%3A%20LETHAL"
                    target="new">
                    BOOK NOW
                </a>
            </div>
...
<section>
    <div class="container">
        <div class="vr_game_video_modal">
            <img src="../img/vr/threat-lethal/video_banner.webp" alt="">
...
<section>
    <div class="all_box_full_width SPACE_MARINE_VR_section">
        <div class="container">
            <div class="SPACE_MARINE_VR">
                <h6>BATTLE ALIEN SWARMS FOR SUPREMACY IN</h6>
                <h3>SPACE MARINE VR - THREAT: LETHAL</h3>
                <p>Defeating alien swarms just got tougher, with team death restarting each brutal level.
                    Mission success is not guaranteed and each attempt is a lesson in survival. Prepare to refine your
                    strategies and Awaken Your Squad Tactics.
                    You’ll need to work together, communicate and help each other if you want to survive this dangerous
                    mission.</p>
            ...
            <div class="row align-items-center">
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>MASTER THE MAYHEM</h1>
                        <p>Threat: Lethal team mode will push your limits with a relentless challenge that demands
                            mastery through repeated play. Your team must revive fallen squadmates while fighting
                            forocious alien swarms. Fail and you'll restart the level, to try again.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_img ">
                        <img src="../img/vr/threat-lethal/vr1.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/threat-lethal/vr2.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>WILL YOU SURVIVE TOGETHER?</h1>
                        <p>You must communicate and coordinate like never before, facing daunting battles that can only
                            be won through united efforts. Advancing through your mission hinges on your squad's ability
                            to adapt, plan, and rally as a cohesive unit.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>RETURN, REFINE, OVERCOME</h1>
                        <p>Success in Threat: Lethal team mode is earned, never given. Not all teams will reach the
                            highest level of this epic experience. If you don't succeed, take a breath and dive back in
                            - armed with experience and improved tactics. Victory awaits your inner competitor.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/threat-lethal/vr3.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
...
<section class="leaderboard_section">
    <div class="container">
        <div class="SPACE_MARINE_VR">
            <h6>Seattle</h6>
            <h3>SPACE MARINE VR THREAT LETHAL TEAM MODE Leaderboard</h3>
...
<section class="Immersive_Escap_Adventures Ultimate_Birthday_Experience gaming-container">
    <div class="container ">
        <div class="SPACE_MARINE_VR">
            <h3>EXPERIENCE THE THRILLd</h3>
            <p>There’s something for everyone</p>
        </div>
         <div class="owl-carousel owl-theme vr_game_slider">
                        <div class="item">
                            <div class="room-card">
                                <div class="room-image haunted-hotel"
                                    style="background-image: url(https://images.ctfassets.net/adsfyhieuvzo/vNhKQcTd8TKgdDs01SiyU/d9307ff6696bb7b6c5fb9067d0ee29fa/Space-Marine-Game-Experience-Threat-Lethal-Tile.jpg?w=469&h=350&fm=webp);">
                                    <!-- <div class="room-icon">
                                        <i class="fas fa-ghost"
                                            style="position: absolute; bottom: 20px; left: 20px; font-size: 30px; color: #FF4500;"></i>
                                    </div> -->
                                </div>
                                ...
                                <div class="room-content">
                                    <div class="room-content_all_ah">
                                        <div class="room-details">
                                            <h3 class="room-title" >Threat LETHAL</h3>
                                            <p class="d-price">Difficulty: <span class="price Easy">Hard</span></p>
                                            <p class="d-price">Game Duration: <span class="price Easy">30 min/ 45
                                                    min</span></p>
                                            <p class="d-price">Players: <span class="price">1-8</span></p>
                                            <a href="space-marine-vr-threat-lethal" class="book-btn">LEARN MORE</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h6 class="color_combination_vr_function text-center">AWAKEN YOUR <span
                                    class="green-highlight" style="color: #cbfd3c;">SQUAD TACTICS</span></h6>
                        </div>
                        <div class="item">
                            <div class="room-card">
                                <div class="room-image haunted-hotel"
                                    style="background-image: url(https://images.ctfassets.net/adsfyhieuvzo/6WOLmgdMwVLNwXIrCGtOIu/68a0e1cce25b74c1c946e9a3f0c593d0/Warhammer-40000-Space-Marine-VR-by-Zero-Latency-Tyranid-Warrior-Game-Experience.jpg?w=720&h=600&fm=webp);">
                                    <!-- <div class="room-icon">
                                        <i class="fas fa-ghost"
                                            style="position: absolute; bottom: 20px; left: 20px; font-size: 30px; color: #FF4500;"></i>
                                    </div> -->
                                </div>
                                <div class="d-label" style="background-size: cover; background-repeat: no-repeat;">Staff
                                    Favorite </div>
                                <div class="room-content">
                                    <div class="room-content_all_ah">
                                        <div class="room-details">
                                            <h3 class="room-title">Space Marine VR</h3>
                                            <p class="d-price">Difficulty: <span class="price Easy">Medium</span></p>
                                            <p class="d-price">Game Duration: <span class="price Easy">30 min</span></p>
                                            <p class="d-price">Players: <span class="price">1-8</span></p>
                                            <a href="space-marine-vr" class="book-btn">LEARN MORE</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="item">
                            <div class="room-card">
                                <div class="room-image haunted-hotel"
                                    style="background-image: url(https://images.ctfassets.net/adsfyhieuvzo/50TkzwCqYcnD3rclElHCWh/14899394cd4cdb8eede543e93b4cce99/ZeroLatency_OUTBREAK_SURVIVOR_Character_Experience_tile_350x469_D.jpg?w=469&h=350&fm=webp);">
                                </div>
                                <div class="d-label" style="background-size: cover; background-repeat: no-repeat;">
                                    Most Popular
                                </div>
                                <div class="room-content">
                                    <div class="room-content_all_ah">
                                        ...
                                        <div class="room-details">
                                            <h3 class="room-title">OUTBREAK</h3>
                                            <p class="d-price">Difficulty: <span class="price Easy">Medium</span></p>
                                            <p class="d-price">Game Duration: <span class="price Easy">Duration: 30
                                                    min</span></p>
                                            <p class="d-price">Players: <span class="price">1-8</span></p>
                                            <a href="outbreak" class="book-btn">LEARN MORE</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h6 class="color_combination_vr_function text-center">AWAKEN THE <span
                                    class="green-highlight" style="color: #c5a4f4;">HERO </span>IN YOU</h6>
                        </div>
                        <div class="item">
                            <div class="room-card">
                                <div class="room-image haunted-hotel"
                                    style="background-image: url(https://images.ctfassets.net/adsfyhieuvzo/21N1yC0dYFsPE8wdFfcW7V/74e1edfc9f765e3439f0ed8cc97cd20a/ZeroLatency_FAR_CRY_SURVIVOR_Character_Experience_tile_350x469_D.jpg?w=469&h=350&fm=webp);">
                                ...
                                <div class="room-content">
                                    <div class="room-content_all_ah">
                                        <div class="room-details">
                                            <h3 class="room-title">FAR CRY</h3>
                                            <p class="d-price">Difficulty: <span class="price Easy">Medium</span></p>
                                            <p class="d-price">Game Duration: <span class="price Easy">30 min</span></p>
                                            <p class="d-price">Players: <span class="price">1-8</span></p>
                                            <a href="far-cry-vr" class="book-btn">LEARN MORE</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h6 class="color_combination_vr_function text-center">AWAKEN YOUR <span
                                    class="green-highlight" style="color: #ed6000;">INNER SURVIVOR</span></h6>
                        </div>
                        <div class="item">
                            <div class="room-card">
                                <div class="room-image haunted-hotel"
                                    style="background-image: url(https://images.ctfassets.net/adsfyhieuvzo/L9dEDSKvfYWvQVhUGTLkq/d8b9e71e0b5e9cb0487a1e63be008998/ZeroLatency_SOL_RAIDERS_TACTICIAN_Character_Experience_tile_350x469_D.jpg?w=469&h=350&fm=webp);">
                                </div>
                                <div class="d-label" style="background-size: cover; background-repeat: no-repeat;">
                                    Player v/s Player
                                </div>
                                <div class="room-content">
                                    <div class="room-content_all_ah">
                                        <div class="room-details">
                                            ...
                                            <h3 class="room-title">SOL RAIDERS</h3>
                                            <p class="d-price">Difficulty: <span class="price Easy">Medium</span></p>
                                            <p class="d-price">Game Duration: <span class="price Easy">30 min</span></p>
                                            <p class="d-price">Players: <span class="price">2-8</span></p>
                                            <a href="sol-raiders" class="book-btn">LEARN MORE</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h6 class="color_combination_vr_function text-center">AWAKEN YOUR <span
                                    class="green-highlight" style="color: #c5a4f4;">FIERCE COMPETITOR</span></h6>
                        </div>
                        <div class="item">
                            <div class="room-card">
                                <div class="room-image haunted-hotel"
                                    style="background-image: url(https://images.ctfassets.net/adsfyhieuvzo/2067c5FkQDiLWTipISbwlb/6af96ee4a6d30dda45f07a11ccbbaa4b/ZeroLatency_SINGULARITY_COMPETITOR_Character_Experience_tile_350x469_D.jpg?w=469&h=350&fm=webp);">
                                    <!-- <div class="room-icon">
                                        <i class="fas fa-ghost"
                                            style="position: absolute; bottom: 20px; left: 20px; font-size: 30px; color: #FF4500;"></i>
                                    </div> -->
                                ...
                                <div class="room-content">
                                    <div class="room-content_all_ah">
                                        <div class="room-details">
                                            <h3 class="room-title">SINGULARITY</h3>
                                            <p class="d-price">Difficulty: <span class="price Easy">Medium</span></p>
                                            <p class="d-price">Game Duration: <span class="price Easy">30 min</span></p>
                                            <p class="d-price">Players: <span class="price">1-8</span></p>
                                            <a href="singularity" class="book-btn">LEARN MORE</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h6 class="color_combination_vr_function text-center">AWAKEN THE <span
                                    class="green-highlight" style="color: #c5a4f4;">LEADER</span> IN YOU</h6>
                        </div>
                        <div class="item">
                            <div class="room-card">
                                <div class="room-image haunted-hotel"
                                    style="background-image: url(https://images.ctfassets.net/adsfyhieuvzo/5iOLdoRphZGVXCnJkUC0vk/4d3dd48610f44c30324e644a4121c886/ZeroLatency_ENGINEERIUM_EXPLORER_Character_Experience_tile_350x469_D.jpg?w=469&h=350&fm=webp);">
                                    <!-- <div class="room-icon">
                                        <i class="fas fa-ghost"
                                            style="position: absolute; bottom: 20px; left: 20px; font-size: 30px; color: #FF4500;"></i>
                                    </div> -->
                                ...
                                <div class="room-content">
                                    <div class="room-content_all_ah">
                                        <div class="room-details">
                                            ...
                                            <h3 class="room-title">Engineerium</h3>
                                            <p class="d-price">Difficulty: <span class="price Easy">Easy</span></p>
                                            <p class="d-price">Game Duration: <span class="price Easy">30 min</span></p>
                                            <p class="d-price">Players: <span class="price">1-8</span></p>
                                            <a href="engineerium" class="book-btn">LEARN MORE</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h6 class="color_combination_vr_function text-center">AWAKEN YOUR <span
                                    class="green-highlight" style="color: #cbfd3c;">IMAGINATION</span></h6>
                        </div>
                        <div class="item">
                            <div class="room-card">
                                <div class="room-image haunted-hotel"
                                    style="background-image: url(https://images.ctfassets.net/adsfyhieuvzo/5y5METWcAEx270jWI4FNVs/e3f71c00bea51548a0455fb3efb28014/ZeroLatency_UNDEAD_ARENA_SCARED_Character_Experience_tile_350x469_D.jpg?w=469&h=350&fm=webp);">
                                    <!-- <div class="room-icon">
                                        <i class="fas fa-ghost"
                                            style="position: absolute; bottom: 20px; left: 20px; font-size: 30px; color: #FF4500;"></i>
                                    </div> -->
                                ...
                                <div class="room-content">
                                    <div class="room-content_all_ah">
                                        <div class="room-details">
                                            <h3 class="room-title">UNDEAD ARENA</h3>
                                            <p class="d-price">Difficulty: <span class="price Easy">Easy</span></p>
                                            <p class="d-price">Game Duration: <span class="price Easy">30 min</span></p>
                                            <p class="d-price">Players: <span class="price">1-8</span></p>
                                            <a href="undead-arena" class="book-btn">LEARN MORE</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h6 class="color_combination_vr_function text-center">AWAKEN THE <span
                                    class="green-highlight" style="color: #FF6F29;">TACTICIAN</span> IN YOU</h6>
                        </div>
                    </div>
    </div>
</section>
...
<section>
    <div class="Release_your_inner_section">
        ...
        <div class="Release_your_inner">
            <div class="container">
                <h3>WANT TO OWN A ZERO LATENCY?</h3>
                <p>Join our global community of Thrillmakers redefining entertainment.</p>
