...
<section>
    <div class="vr_page_banner" style="background-image: url(../img/vr/haunted//banneer.webp);">
        <div class="container">
            <div class="vr_page_banner_content">
                <img src="../img/vr/haunted/logo.webp" alt="">
                <p>Dare to enter. Hope to escape.</p>
                <a class=" bg_bnt_custom mt-3"
                    href="https://booking.zerolatencyvr.com/en/?game=haunted&zl_s=GlobalWebsite&zl_sp=%2Fen%2Fexperience%2Fhaunted&zl_ct=PageBanner&zl_cin=%5BHQ%5D%20Global%20%7C%20Haunted%20%7C%20Page%20Banner&zl_cti=Haunted"
                    target="new">
                    BOOK NOW
                </a>
            </div>
...
<section>
    <div class="container">
        <div class="vr_game_video_modal">
            <img src="../img/vr/haunted/video_baneer.webp" alt="">
    ...
    <div class="all_box_full_width SPACE_MARINE_VR_section">
        <div class="container">
            <div class="SPACE_MARINE_VR">
                <h6>Halloween Special</h6>
                <h3>Awaken the Fear Within</h3>
                <p>Haunted is the latest in full-body, ultra-immersive VR terror. A world that doesn’t just look scary,
                    but feels scary. Your hands shake. Your heart races. You'll need to stick together to survive. But
                    be careful. The house will do anything to get you alone. Tickets on sale now.</p>
            ...
            <div class="row align-items-center">
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_Content">
                        ...
                        <p>You enter Haunted as a group. But staying together? That’s another story. The house wants to
                            get you alone. It whispers and twists, luring players into the dark. Whatever happens, don’t
                            split up.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_img ">
                        <img src="../img/vr/haunted/vr1.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/haunted/vr2.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>VIRTUAL HORROR. REAL FEAR</h1>
                        <p>Haunted uses next-gen 360° immersion, spatial sound and 5K resolution to bring your darkest
                            fears to life. It's the scariest, realest full-body immersive experience.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-right" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    <div class="ENTER_NEW_WORLD_Content">
                        <h1>STEP INTO TERROR</h1>
                        <p>This is a heart-pounding, white-knuckle, group-based thrill ride. A world where horror
                            doesn’t just look scary, it feels scary. It’s time to find out for real – who’s the bravest
                            of them all?.</p>
                    </div>
                </div>
                <div class="col-sm-6" data-aos="fade-left">
                    <div class="ENTER_NEW_WORLD_img">
                        <img src="../img/vr/haunted/vr3.webp" alt="Enter New Worlds" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
...
<section>
    <div class="Release_your_inner_section">
        ...
        <div class="Release_your_inner">
            <div class="container">
                <h3>DARE TO ENTER THE HAUNTED HOUSE?</h3>
