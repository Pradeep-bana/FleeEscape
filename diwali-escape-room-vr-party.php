...
$canonicalURL = $link."diwali-escape-room-vr-party";
$videoModalTitle = 'Diwali';
...
$selectedPage = 'diwali'; // can be dynamic as needed
...
// Fetch data for selected page
$selectedPage = 'diwali'; // change dynamically if needed
...
// Fetch data for selected page
$selectedPage = 'diwali'; // set dynamically if needed
...
$selectedPage = 'diwali'; // or dynamic based on current page
...
<div class="faq-section fade-in-up" style="animation-delay: 0.6s;">
    ...
    <div class="form-group">
        <input id="enq_phone" name="phone" type="tel" placeholder="Phone Number *" required maxlength="10"  pattern="[0-9]{10}"  oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);">
